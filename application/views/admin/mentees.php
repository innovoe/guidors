                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right" role="menu" >
                                              ...
                                              <?php elseif ($user->status == 0): ?>
                                                <a href="<?php echo base_url('admin/mentee/status_action/1/'.html_escape($user->id));?>" class="dropdown-item"><i class="lnib lni-checkmark-circle mr-1"></i><?php echo trans('approve') ?></a>

                                                <a href="#rejectModal_<?php echo $i ?>" data-toggle="modal" class="dropdown-item"><i class="lnib lni-cross-circle mr-1"></i><?php echo trans('reject') ?></a>
                                              <?php else: ?>
                                                  <a href="<?php echo base_url('admin/mentee/status_action/1/'.html_escape($user->id));?>" class="dropdown-item"><i class="lnib lni-checkmark-circle mr-1"></i>  <?php echo trans('activate') ?></a>
                                              <?php endif ?>
...
<div class="modal fade" id="rejectModal_<?php echo $c ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Registrant Rejection</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form method="post" action="<?php echo base_url('admin/mentee/status_action/3/'.$user->id) ?>">
          <label>Reject Reason</label>
          <textarea class="form-control mb-3" rows="8" name="reject_reason"></textarea>
