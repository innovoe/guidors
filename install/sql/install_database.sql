...
--
-- Host: localhost:8889
-- Generation Time: Jun 07, 2026 at 07:00 AM
...
(24, 0, 'Registrant Confirmation', 'registrant-confirmation', 'We\'ve Received Your Application', '<p>Hello {{user_name}},</p>\r\nThank you for registering! Your application is currently under review. We\'ll notify you once a decision has been made.\r\nIf you have any questions, feel free to contact us.\r\n', '{{user_name}}'),
(25, 0, 'Admin New Application Alert', 'admin-new-application-alert', 'New Registration Pending Approval', '<p>Hi Admin,\r\n</p><p>A new user has just registered and is awaiting your approval.\r\nName: {{user_name}}\r\nEmail: {{user_email}}\r\nRegistered: {{date}}\r\nPlease log in to the admin panel to review and take action.\r\n</p>', '{{user_name}}, {{user_email}}, {{date}}'),
(26, 0, 'Registrant Approval', 'registrant-approval', 'Your Account Has Been Approved', '<p>Hi {{user_name}},\n</p><p>Great news! Your account has been approved. You can now log in and get started.\nLogin here: {{login_url}}\nWelcome aboard — we\'re glad to have you!\n</p>', '{{user_name}}, {{login_url}}'),
(27, 0, 'Registrant Rejection', 'registrant-rejection', 'Application Status Update', '<p>Hi {{user_name}},\n</p><p>Unfortunately, your registration has not been approved at this time.\nReason: {{rejection_reason}}\nIf you believe this was a mistake or have further questions, please don\'t hesitate to contact us.</p>', '{{user_name}}, {{rejection_reason}}'),
(28, 0, 'Admin Pending Reminder', 'admin-pending-reminder', '⏰ Pending Registrations Awaiting Review', '<p>Hi Admin,\n</p><p>This is a reminder that you have {{count}} pending registration(s) that have been waiting for more than {{days}} days.\nPlease log in to the admin panel to review them.</p>', '{{count}}, {{days}}');
...
(1078, 'user', 'View', 'view', 'View'),
(1079, 'user', 'Icon', 'icon', 'Icon'),
(1080, 'user', 'Number', 'number', 'Number'),
(1081, 'user', 'Text', 'text', 'Text'),
(1090, 'user', 'Meta_tags', 'meta_tags', 'Meta tags'),
(1091, 'user', 'Meta_desc', 'meta_desc', 'Meta description'),
(1101, 'user', 'Link', 'link', 'Link'),
(1102, 'user', 'Subcategory', 'subcategory', 'Subcategory'),
(1103, 'user', 'Short_desc', 'short_desc', 'Short description'),
(1107, 'user', 'Total views', 'total-views', 'Total views'),
(1108, 'user', 'Created_at', 'created_at', 'Created at'),
(1117, 'user', 'Download successfully', 'download-successfully', 'Download successfully'),
(1118, 'user', 'Subcategories', 'subcategories', 'Subcategories'),
(1141, 'admin', 'Orders', 'orders', 'Orders'),
(1143, 'user', 'Created at', 'created-at', 'Created at'),
(1144, 'user', 'Gateway', 'gateway', 'Gateway'),
...
(1192, 'user', 'Accepted', 'accepted', 'Accepted'),
(1193, 'user', 'Reject', 'reject', 'Reject'),
(1194, 'user', 'Activate Successfully', 'activate-successfully', 'Activate Successfully'),
(1195, 'user', 'Update status successfully', 'update-status-successfully', 'Update status successfully'),
(1196, 'admin', 'Booking_Status', 'booking_status', 'Booking Status'),
(1197, 'user', 'Payment Status', 'payment_status', 'Payment Status'),
(1204, 'admin', 'Work Flow', 'work-flow', 'Work Flow'),
(1206, 'user', 'Applied successfully', 'applied-successfully', 'Applied successfully'),
(1207, 'user', 'Sent message successfully', 'sent-message-successfully', 'Sent message successfully'),
...
(1225, 'user', 'Pagination limit', 'pagination-limit', 'Pagination limit'),
(1226, 'user', 'Site color', 'site-color', 'Site color'),
(1228, 'user', 'Youtube', 'youtube', 'Youtube'),
...
(1733, 'admin', 'Require Admin Approval for New Registrations', 'require-admin-approval-for-new-registrations', 'Require Admin Approval for New Registrations');
...
CREATE TABLE `settings` (
  ...
  `enable_regtration_approval` int(11) DEFAULT '0',
