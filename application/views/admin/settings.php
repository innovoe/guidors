                        ...
                        <div class="tab-pane fade" id="prefrences" role="tabpanel" aria-labelledby="prefrences-tab">
                            <div class="form-group">
                                <div class="col-sm-12 mt-15">
                                  ...
                                  <div class="custom-control custom-switch prefrence-item ml-10 mt-25">
                                      <input type="checkbox" name="enable_regtration_approval" class="custom-control-input" value="1" id="mentor_auto_approve" <?php if($settings->enable_regtration_approval == 1){echo "checked";} ?>>
                                      <label class="custom-control-label" for="mentor_auto_approve"><?php echo trans('require-admin-approval-for-new-registrations') ?></label>
