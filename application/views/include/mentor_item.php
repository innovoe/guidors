        ...
        <div class="cards b1 mb-4 br-6 p-2 lift-sm hover-shadow">
          ...
          <div class="card-body pl-1 pr-1 pb-1">
            ...
            <div class="mt-2 mb-3 text-dark pl-2 pr-2 fs-13">
                <?php if (!empty($mentor->designation) || !empty($mentor->company)): ?>
                    <span>
                        <?php if (!empty($mentor->designation)): ?>
                            <i class="bi bi-briefcase mr-1"></i> <?php echo html_escape($mentor->designation) ?>
                        <?php endif ?>
                        <?php if (!empty($mentor->company)): ?>
                            <?php if (!empty($mentor->designation)): ?>
                                <span class="text-muted fw-500"><?php echo trans('at') ?></span>
                            <?php endif ?>
                            <?php echo html_escape($mentor->company) ?>
                        <?php endif ?>
                    </span>
                <?php endif ?>
            </div>
            ...
            <?php if($total_sessions > 0): ?>
                <div class="pl-2">
                    <p class="fs-13"><i class="bi bi-chat"></i> <?php echo html_escape( $total_sessions); ?> <?php echo trans('sessions') ?>
