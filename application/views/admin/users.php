                ...
                <div class="card-header">
                  <h3 class="card-title"><?php echo trans('mentors') ?></h3>
                    <div class="card-tools">
                      <a href="<?php echo base_url('admin/users/add') ?>" class="btn btn-secondary btn-sm mr-2">
                        <i class="fas fa-plus"></i> <?php echo trans('create-new') ?>
                      </a>
                                      ...
                                      <div class="btn-group">
                                          ...
                                          <div class="dropdown-menu dropdown-menu-right" role="menu" >
                                            ...
                                            <?php elseif ($user->status == 0): ?>
                                              <a href="<?php echo base_url('admin/users/status_action/1/'.html_escape($user->id));?>" class="dropdown-item"><i class="lnib lni-checkmark-circle mr-1"></i><?php echo trans('approve') ?></a>
...
<div class="modal fade" id="rejectModal_<?php echo $c ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="<?php echo base_url('admin/users/status_action/3/'.$user->id) ?>">
