<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a target="_blank" href="<?php echo base_url() ?>" class="brand-link">
      <img src="<?php echo base_url('apple-touch-icon.png') ?>" alt="AdminLTE Logo" class="brand-image img-circle">
      <span class="brand-text font-weight-bold"><?php echo html_escape(lang_value()->site_name) ?></span>
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a class="nav-link <?php if(isset($page_title) && $page_title == "Email Template"){echo "active";} ?>" href="<?php echo base_url('admin/email_templates') ?>">
                  <i class="nav-icon bi bi-envelope ml-2 mr-2"></i> <p><?php echo trans('email-templates') ?></p>
                </a>
              </li>
