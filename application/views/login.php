            ...
            <div class="col-md-5 p-5 mx-auto my-5" data-aos="fade-up" data-aos-duration="400">
                <div class="shadow rounded bg-white py-6 px-6 border-0" id="login-area">
                    ...
                    <div class="mb-6 text-center">
                        <?php get_last_logins(); ?>
                        <h4 class="font-weight-bold mb-2"><a href="<?php echo base_url() ?>"><img class="site-logo" src="<?php echo base_url(settings()->logo) ?>" alt="<?php echo html_escape(lang_value()->site_name) ?>"></a></h4>
                ...
                <div id="forgot-area" class="shadow-sm rounded bg-white py-6 px-8 border-0 d-hide">
                    ...
                    <div class="mb-6 text-center">
                        <h2 class="font-weight-bold mb-0"><a href="<?php echo base_url() ?>"><img class="site-logo" src="<?php echo base_url(settings()->logo) ?>" alt="<?php echo html_escape(lang_value()->site_name) ?>"></a></h2>
