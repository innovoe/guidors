    ...
    <?php if (isset($menu) && $menu == TRUE): ?>
        <?php if (settings()->front_layout == 1): ?>
            <footer class="pt-8 border-top border-light">
                <div class="container">
                    <div class="row pb-5">
                        <div class="col-sm-8 col-lg-8 mb-5 mb-lg-0">
                            <img src="<?php echo base_url(settings()->logo) ?>" class="site-logo mb-4" alt="<?php echo html_escape(lang_value()->site_name) ?>">
                            <p class=""><?php echo html_escape(lang_value()->footer_about) ?></p>
                        ...
                        <div class="col-sm-4 col-lg-3 mb-5 mb-lg-0 ml-lg-auto">
                ...
                <div class="text-center border-top border-light">
                    <div class="container">
                        <div class="row py-4">
                            <div class="col-md-12">
                                <p class="mb-0"><?php echo html_escape(lang_value()->copyright) ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-12 text-center">
                            <h2 class="footer-heading"><a href="#" class="logo"><?php echo lang_value()->site_name ?></a></h2>
                            <p class="menu">
                    ...
                    <div class="row mt-5">
                        <div class="col-md-12 text-center">
                            <p class="copyright fs-13">
                                <?php echo html_escape(lang_value()->copyright) ?>
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <?php if(isset($page_title) && $page_title == 'Home' && settings()->front_layout == 1): ?>
        <script src="<?php echo base_url() ?>assets/front/js/home-custom.js?var=<?= settings()->version ?>&time=<?=time();?>"></script>
    <?php endif; ?>
    <!-- stripe js -->
